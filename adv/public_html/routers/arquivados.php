...
<body>
    ...
    $query = "SELECT * FROM arquivados ORDER BY dataatual ASC";
...
if (isset($_GET['filtroRegime'])) {
    ...
    if ($filtroRegime === "Regime Aberto" || $filtroRegime === "Liberdade Condicional") {
        $query = "SELECT * FROM arquivados WHERE selecao = '$filtroRegime' ORDER BY dataatual ASC";
    }
} else {
    $query = "SELECT * FROM arquivados ORDER BY dataatual ASC";
}
...
$totalClientes = $countRow['total'];
    ...
    // Conta o número total de registros da tabela 'arqvuiados'
...
?>
    ...
    <div class="container">
        <div class="navside">
            ...
            <ul>
                <li onclick="history.back()"><img src="../images/dash.png" class="imgDash"><a href="../index.php"> Dashboard</a></li>
        ...
        <div class="tables">
            ...
            <span class="menuSuperior"><h3> Arquivados </h3> <button id="printButton">Imprimir Selecionados</button></span>
           <div>
                <table id="dataTable1">
                    <thead>
                        <tr>
...
?>
    ...
    <script src="../javascript/editArquivados.js"></script>
