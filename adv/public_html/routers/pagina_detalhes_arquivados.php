...
<div class="details">
    ...
    <span class="Span2">
      <form action="../service/process_edit_arquivados.php" method="POST">
        ...
        <p><b>Data:</b> <input value="<?php echo $dataatual; ?>" id="dataInput" class="inputDisabled" name="dataatual" disabled></p>
...
<script>
    function confirmExclusao(id) {
        if (confirm("Tem certeza de que deseja excluir este cliente?")) {
            window.location.href = "../service/process_delete_arquivados.php?id=" + id;
        }
    }
</script>
<script>
